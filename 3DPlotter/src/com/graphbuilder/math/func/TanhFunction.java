...
*/
public class TanhFunction extends AbstractOneVariableFunction {
	...
	*/
	...
	public Expression getOuterDerivative(Expression inner, FuncMap f, String varName) {
		FuncNode cos = new FuncNode("cosh", false);
		cos.add(inner);
		
		PowNode cosSquared = new PowNode(cos, Expression.TWO);
		
		return new DivNode(Expression.ONE, cosSquared);
	}
}