...
public class SphGridOptionPanel extends AbstractGridOptionPanel implements GridOptionPanel{
	...
	public SphGridOptionPanel(String[] bounds) {
		...
		JLabel yLabel = new JLabel("< theta <");
