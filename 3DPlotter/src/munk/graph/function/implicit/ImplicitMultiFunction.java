...
public class ImplicitMultiFunction extends AbstractFunction {
	...
	public ImplicitMultiFunction(String[] expr, Color3f color, String[] bounds, float[] stepSize) 
		...
		super(expr,color,bounds,stepSize, new ImplicitMulti(expr[0], GuiUtil.evalString(bounds[0]),GuiUtil.evalString(bounds[1]),GuiUtil.evalString(bounds[2]),GuiUtil.evalString(bounds[3]),GuiUtil.evalString(bounds[4]),GuiUtil.evalString(bounds[5]),stepSize));
	}
